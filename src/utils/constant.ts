...
export const applicationDetailsFields = [
  ...
  { label: "Product", key: "productOpted" },
  { label: "Product Type", key: "planOpted" },
...
export const rm_sub_category = [
  ...
  {
    label: "Medical Questionairre Required",
    value: "Medical Questionairre Required",
  },
  { label: "Non Medical", value: "Non Medical" },
  ...
  {
    label: "Medical Questionnaire Required",
    value: "Medical Questionnaire Required",
  },
  ...
  {
    label: "Self employed/Business/professional",
  ...
  {
    label: "Nominee/PEP/EBI/personal details",
    value: "Nominee/PEP/EBI/personal details",
  },
...
export const rm_reason = [
  ...
  {
    label: "Incomplete/Invalid document submitted",
    value: "INCOMPLETE_INVALID_DOCUMENT",
  },
  ...
  {
    label: "Latest income proof required",
    value: "LATEST_INCOME_PROOF_REQUIRED",
  },
  { label: "Income proof not clear", value: "INCOME_PROOF_NOT_CLEAR" },
  {
    label: "Clear copy of Latest income proof required",
    value: "CLEAR_COPY_INCOME_PROOF_REQUIRED",
  },
  ...
  {
    label: "Policies with other insurance company",
    value: "OTHER_INSURANCE_POLICIES",
  },
  { label: "Income proof not given", value: "INCOME_PROOF_NOT_GIVEN" },
  {
    label:
      "Surrogates required as additional income proof for financial eligibility",
    value: "SURROGATES_REQUIRED",
  },
  {
    label: "Mismatch in documents submitted with application form",
    value: "DOCUMENT_APPLICATION_MISMATCH",
  },
  {
    label: "Medical Questionnaire Required",
    value: "MEDICAL_QUESTIONNAIRE_REQUIRED",
  },
  {
    label: "Non medical Questionnaire not submitted",
    value: "NON_MEDICAL_QUESTIONNAIRE_NOT_SUBMITTED",
  },
  ...
  {
    label: "Medical history noted on application form /MER/TU/VMER",
    value: "MEDICAL_HISTORY_DISCLOSED",
  },
  {
    label: "Partial income proof submitted",
    value: "PARTIAL_INCOME_PROOF_SUBMITTED",
  },
  {
    label: "Additional medical test required",
    value: "ADDITIONAL_MEDICAL_TEST_REQUIRED",
  },
  { label: "Copy submitted is not clear", value: "COPY_NOT_CLEAR" },
  {
    label: "Discrepancy noted on Loan sanction letter",
    value: "LOAN_SANCTION_LETTER_DISCREPANCY",
  },
  {
    label: "Additional business income proof required",
    value: "ADDITIONAL_BUSINESS_INCOME_PROOF_REQUIRED",
  },
  {
    label: "Shareholding of life assured in partnership business",
    value: "SHAREHOLDING_DETAILS_REQUIRED",
  },
  {
    label: "Medical adversity disclosed in TU/VMER/MER",
    value: "MEDICAL_ADVERSITY_DISCLOSED",
  },
  { label: "For processing case", value: "PROCESSING_CASE" },
  {
    label: "Financial grid/Financial eligibility calculation",
    value: "FINANCIAL_GRID_REQUIRED",
  },
  {
    label: "Submitted income proof not clear",
    value: "SUBMITTED_INCOME_PROOF_NOT_CLEAR",
  },
  {
    label: "Documents uploaded is not clear",
    value: "DOCUMENTS_UPLOADED_NOT_CLEAR",
  },
  {
    label: "Mandatory document not submitted",
    value: "MANDATORY_DOCUMENT_NOT_SUBMITTED",
  },
  {
    label: "ECS/Bank Details not submitted",
    value: "ECS_BANK_DETAILS_NOT_SUBMITTED",
  },
  {
    label: "Mandatory medicals not done",
    value: "MANDATORY_MEDICALS_NOT_DONE",
  },
  {
    label: "Mandatory details are not provided",
    value: "MANDATORY_DETAILS_NOT_PROVIDED",
  },
  {
    label: "Mandatory document not provided",
    value: "MANDATORY_DOCUMENT_NOT_PROVIDED",
  },
  {
    label: "Policies with other insurance companies noted in Proposal status",
    value: "PROPOSAL_STATUS_OTHER_POLICIES",
  },
  {
    label: "Income proof given is not clear",
    value: "INCOME_PROOF_GIVEN_NOT_CLEAR",
  },
  {
    label: "Submitted document is not clear",
    value: "SUBMITTED_DOCUMENT_NOT_CLEAR",
  },
