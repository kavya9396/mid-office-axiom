...
export const title = {breDecision:"Bre Decision",decision:"Case Decision",applicationOverview:"Application Details",applicantDetails:"Applicant Details",backToInbox:"Back to Inbox" }
