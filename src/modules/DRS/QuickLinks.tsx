...
const QuickLinks = ({
    ...
    const quickLinks: QuickLinkItem[] = [
        ...
        ...(roleType !== 'CVT_TASK' && roleType !== 'DVT_TASK' && roleType !== 'PIVV_TASK' && roleType !== 'CUW_CLAIM_AUDIT_TASK' && roleType !== "GROUP_VENDOR_CMO_TASK" && roleType !== "GROUP_CMO_TASK" && roleType !== "MAS_TASK" ? [
            {
