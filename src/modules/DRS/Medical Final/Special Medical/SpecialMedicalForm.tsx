...
import type { MedicalFinalConfigField } from "./specialMedicalConfig";
...
const SpecialMedicalForm = ({ selectedSubSection, fields }: SpecialMedicalFormProps) => {
  return (
    <Box>
      <Typography sx={{ fontSize: 16, fontWeight: 700, color: "#1F2937", mb: 1 }}>
        {selectedSubSection ?? "Special Medical"}
      </Typography>
      <Typography sx={{ color: "#667085", fontSize: 13 }}>
        Special Medical form details will be rendered from config in the next iteration.
      </Typography>
