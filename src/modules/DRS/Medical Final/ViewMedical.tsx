...
interface ViewMedicalProps {
  onBack?: () => void;
  backLabel?: string;
}

const ViewMedical = ({ onBack, backLabel }: ViewMedicalProps) => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {backLabel ?? (onBack ? "Back to CMO Summary" : isCptMedicalRole ? title.backToCPT : title.backToDRS)}
        </CustomButton>
