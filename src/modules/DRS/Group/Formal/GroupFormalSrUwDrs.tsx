...
interface GroupFormalSrUwDrsProps {
    onBackToInbox?: () => void;
...
const GroupFormalSrUwDrs = ({
    ...
    const [srUwRemarks, setSrUwRemarks] = useState("");
    const [srUwDecision, setSrUwDecision] = useState("");
    ...
    const storageBusinessType = "group";
    const eventName = "BRE-GROUP";
                  ...
                  {breRemarks}
                                ...
                                >
                                    ...
                                    <TextField
                                        ...
                                        disabled={readOnly}
                                    >
                                        {SR_UW_DECISION_OPTIONS.map((option) => (
...
export default GroupFormalSrUwDrs;
