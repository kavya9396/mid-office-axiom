...
const STATIC_GRIEVANCE_ROWS: GrievanceRow[] = [
  {
    ...
    grievanceRemarks: "ECG graph is blurry",
    tpaRemark: "",
    raisedDate: "7 Sep 2026",
    updatedDate: "-",
    raisedBy: "Premanand Sawant",
    updatedBy: "-",
  },
];
...
const GRIEVANCE_HISTORY_COLUMNS: Column<GrievanceRow>[] = [
  // { key: "userName", header: "User Name", width: "11%" },
  { key: "fupCode", header: "FUP Code", width: "8%" },
  { key: "profile", header: "Profile", width: "10%" },
  {
    key: "grievanceRemarks",
    header: "Grievance Remarks",
    width: "17%",
  },
  { key: "tpaRemark", header: "TPA Remark", width: "17%" },
  { key: "raisedBy", header: "Raised by", width: "10%" },
  { key: "raisedDate", header: "Raised Date", width: "9%" },
  {
    key: "updatedBy",
    header: "Updated By",
    width: "9%",
  },
  { key: "updatedDate", header: "Updated Date", width: "9%" },
];
...
const GroupGrievance = ({ paginationDisabled = true }: GrievanceProps) => {
  ...
  const tpaGrievanceColumns: Column<GrievanceRow>[] =
    GRIEVANCE_HISTORY_COLUMNS.map((column) => {
      if (column.key !== "tpaRemark") {
        return column;
      }
