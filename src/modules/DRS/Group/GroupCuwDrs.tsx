...
const GroupCUWDRS = ({
  ...
  /* ------------------------------------------------------------------------ */
  /* PERSONAL SUMMARY IN THE GROUP GRIEVANCE EXAMPLE                         */
  /* ------------------------------------------------------------------------ */
  const personalSummary = "38 years / Male / Graduate / ₹50,00,000 p.a. / India / IND";
