...
// import HOCMOMedicalDecisionTable, {
//   HO_CMO_DECISION_OPTIONS,
//   type HOCMODecision,
//   type HOCMOMedicalDecisionRow,
// } from "./GroupHOCMODecisionTable";
...
// interface GroupHOCMOApplicationSummaryProps {
//   onBackToInbox?: () => void;
//   onViewMedicals?: () => void;
...
// const toHOCMODecision = (value: unknown): HOCMODecision | "" => {
//   const normalizedValue = String(value ?? "").trim().toUpperCase();

//   return (
//     HO_CMO_DECISION_OPTIONS.find(
//       (option) => option.toUpperCase() === normalizedValue,
//     ) ?? ""
//   );
// };

// const mapHOCMODecisionRows = (
//   requirements: UnknownRecord[],
// ): HOCMOMedicalDecisionRow[] =>
...
//       firstValue(
//         requirement.vendorCmoOpinion,
//         requirement.vendorCMOOpinion,
//         requirement.vendorCmoDecision,
//         requirement.vendorCMODecision,
...
//       firstValue(
//         requirement.vendorCmoRemarks,
//         requirement.vendorCMORemarks,
//         requirement.cmoRemarks,
//         requirement.remarks,
//       ) ?? "",
//     ),
//     cmoDecision: toHOCMODecision(
//       firstValue(
//         requirement.hoCmoDecision,
//         requirement.hoCMODecision,
//         requirement.finalCmoDecision,
//         requirement.finalCMODecision,
//       ),
//     ),
//     cmoRemarks: String(
//       firstValue(
//         requirement.hoCmoRemarks,
//         requirement.hoCMORemarks,
//         requirement.finalCmoRemarks,
//         requirement.finalCMORemarks,
//       ) ?? "",
//     ),
//   }));
...
// const GroupHOCMOApplicationSummary = ({
//   onBackToInbox,
//   onViewMedicals,
...
//   decisionHistory,
//   stickyTop = 0,
// }: GroupHOCMOApplicationSummaryProps) => {
...
//   const [hoCmoDecisionRows, setHOCMODecisionRows] = useState<
//     HOCMOMedicalDecisionRow[]
//   >(() => mapHOCMODecisionRows(requirementRows));
...
//                 type="button"
//                 variant="contained"
//                 onClick={() => void onSubmit?.(hoCmoDecisionRows)}
//                 sx={{ borderRadius: "50px" }}
//               >
...
// export default GroupHOCMOApplicationSummary;
...
//         }}
//       >
//         {coverageSummaryItems.map((item, index) => (
//           <Box
//             component="span"
//             key={item.label}
//             sx={{ display: "inline-flex", gap: 0.35 }}
...
//   const loanDetails = {
//     ...toRecord(applicationOverview.loanDetails),
//     ...toRecord(baseProduct.loanDetails),
//   };

//   const productSummaryValue = (...keys: string[]): unknown =>
//     firstValue(
//       ...keys.flatMap((key) => [
//         baseProduct[key],
//         loanDetails[key],
//         applicationOverview[key],
//       ]),
//     );
...
//       label: "MPH Name",
//       value: text(
//         productSummaryValue("mphName", "masterPolicyHolderName"),
//       ),
//     },
//     {
//       label: "PAD",
//       value: text(productSummaryValue("pad", "PAD")),
//     },
//     {
...
//       value: text(productSummaryValue("coverageOption")),
//     },
//     {
//       label: "Loan type",
//       value: text(productSummaryValue("loanType")),
//     },
//     {
//       label: "Bank type",
//       value: text(productSummaryValue("bankType")),
//     },
//     {
//       label: "Loan term",
//       value: text(productSummaryValue("loanTerm")),
//     },
//     {
//       label: "Loan Account No.",
//       value: text(
//         productSummaryValue("loanAccountNo", "loanAccountNumber"),
//       ),
//     },
//     {
//       label: "Share of loan",
//       value: text(productSummaryValue("shareOfLoan", "loanShare")),
//     },
//     {
//       label: "Applicant status",
//       value: text(productSummaryValue("applicantStatus")),
//     },
//     {
//       label: "Loan amount",
//       value: currency(productSummaryValue("loanAmount")),
//     },
//     {
//       label: "Master policy holder code",
//       value: text(
//         productSummaryValue(
//           "masterPolicyHolderCode",
//           "mphCode",
//         ),
//       ),
//     },
//     {
//       label: "Type of loan",
//       value: text(productSummaryValue("typeOfLoan")),
//     },
//   ];
...
//       label: "TRSA",
//       value: currency(
//         productSummaryValue("trsa", "totalReducedSumAssured"),
//       ),
//     },
//     { label: "TPSA", value: tpsa },
//     { label: "TFSA", value: tfsa },
//     { label: "TSSA", value: tssa },
//     {
//       label: "ADBR TSA",
//       value: currency(productSummaryValue("adbrTsa", "adbrTSA")),
//     },
//     {
//       label: "ATPD TSA",
//       value: currency(productSummaryValue("atpdTsa", "atpdTSA")),
//     },
//     {
//       label: "CI Rider TSA",
//       value: currency(productSummaryValue("ciRiderTsa", "ciRiderTSA")),
//     },
//     {
//       label: "CI Rider TRSA",
//       value: currency(
//         productSummaryValue("ciRiderTrsa", "ciRiderTRSA"),
//       ),
//     },
//     {
//       label: "BTBB TSA",
//       value: currency(productSummaryValue("btbbTsa", "btbbTSA")),
//     },
//   ];
