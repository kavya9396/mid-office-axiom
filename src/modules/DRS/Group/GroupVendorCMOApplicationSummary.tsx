...
// } from "./GroupVendorCMOMedicalDecisionTable";
...
// const GroupVendorCMOApplicationSummary = ({
//   onBackToInbox,
//   onViewMedicals,
...
// export default GroupVendorCMOApplicationSummary;
    ...
    >
      ...
      >
        {[...loanSummaryItems, ...coverageSummaryItems].map((item, index) => (
          ...
          >
            {index > 0 && <Box component="span">/</Box>}
            <Box component="span" sx={{ fontWeight: 800, fontSize: "11px" }}>
              {item.label}:
            </Box>
