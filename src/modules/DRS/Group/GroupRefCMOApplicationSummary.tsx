...
// import RefCMODecisionTable, {
//   REF_CMO_HARDCODED_ROWS,
//   type RefCMODecisionRow,
// } from "./GroupRefCMODecisionTable";
...
// interface GroupRefCMOApplicationSummaryProps {
//   onBackToInbox?: () => void;
//   readOnly?: boolean;
...
// interface RefCMOCaseSnapshotRowProps {
...
// const GroupRefCMOApplicationSummary = ({
//   onBackToInbox,
//   readOnly = false,
...
//   decisionHistory,
//   stickyTop = 0,
// }: GroupRefCMOApplicationSummaryProps) => {
...
//   const hasStickyRail = Boolean(quickLinks);
...
// export default GroupRefCMOApplicationSummary;

// /* -------------------------------------------------------------------------- */
// /* STANDALONE CASE SNAPSHOT ROW                                               */
// /* -------------------------------------------------------------------------- */

// export const RefCMOCaseSnapshotRow = ({
//   breDecision,
//   applicationOverview,
//   applicantSummary,
//   riskAnalytics,
//   quickLinks,
// }: RefCMOCaseSnapshotRowProps) => {
//   const hasStickyRail = Boolean(quickLinks);
